...
const MeetingPage = () => {
  ...
  useEffect(()=>{
      Symbl.ACCESS_TOKEN = `eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlFVUTRNemhDUVVWQk1rTkJNemszUTBNMlFVVTRRekkyUmpWQ056VTJRelUxUTBVeE5EZzFNUSJ9..XDh2H6h_8e3ghpp7oOfluq0WQTaE3mvkRb3r-Z2KZ1hkCF-2Rs1bmuVCesN9beoFmYKD6SmeQCnwshmBqgArSZsfDLzZr2XA6rUkvCshIgajYqWDqw1ROHCVwQxqoMLdUV-aWUsoaDi66AqoLbYy0013PEDNPnfl7PD_jAlG4KOFC7RGFxPtzzD9hK238qJBMLChnqWWWwebF3Uq_KSdHH15hQYKh50LPwDuSvnSuiFoMcd4QC7z0cPmys4K2h5S1nDrdARhE7ESM60G4jc2RmwQvD-glILP_NNPsrAqflI6DKTI2eYXXlZLOI4ewaDe_R93NY4k6gqmb8l71-kj8w`;
      const symbl = new Symbl({
          attendeeId: 'afjefkdlkjelj',
